...
import { HomeIcon, PersonIcon, ChatBubbleIcon } from "@radix-ui/react-icons";
  ...
  return (
    <div onMouseEnter={() => setActive(item)} className="relative ">
      <motion.p
        ...
        className="cursor-pointer text-slate-300 hover:opacity-[0.9] "
      >
        {item}
      </motion.p>
      {active !== null && (
          ...
          {active === item && (
            <div className="absolute top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 pt-4">
              <motion.div
                ...
                className="bg-slate-900 backdrop-blur-sm rounded-2xl overflow-hidden border border-black/[0.2] dark:border-white/[0.2] shadow-xl"
              >
                <motion.div
...
const Menu = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex-none font-bold tracking-widest">Get Started</div>
    </nav>
  );
};
